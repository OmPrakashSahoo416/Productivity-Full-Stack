...
function ListHeader({list} : {list:List}) {
  ...
  return (
    ...
    <div className="listTitle w-full flex items-center justify-normal">
          ...
          <Button onClick={() => DeleteList(list?.id, list?.boardId)}  variant={"ghost"} className="rounded-md hover:bg-rose-600 hover:text-slate-100 p-1 mr-1 h-auto w-auto" ><X size={15}></X></Button>
