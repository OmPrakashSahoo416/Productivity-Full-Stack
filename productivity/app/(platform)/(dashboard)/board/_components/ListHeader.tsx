...
function ListHeader({list} : {list:List}) {
  ...
  return (
    ...
    <div className="listTitle  w-full flex items-center justify-normal sticky top-0 bg-slate-400 ">
          ...
          <Button onClick={() => DeleteList(list?.id, list?.boardId)}  variant={"ghost"} className="rounded-md hover:bg-rose-500 hover:text-slate-100 text-xs border border-slate-300 p-1 mr-1 h-auto w-auto" >Delete</Button>
